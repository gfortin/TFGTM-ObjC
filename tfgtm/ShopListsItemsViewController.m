...
- (IBAction)onAdd:(id)sender
{
    ...
    [itemsEmoji setValue:@"🐟" forKey:@"Saumon"];
    [itemsEmoji setValue:@"🐟" forKey:@"Merlu"];
    [itemsEmoji setValue:@"🐟" forKey:@"Truite"];
    [itemsEmoji setValue:@"🐟" forKey:@"Sardine"];
    ...
    [itemsEmoji setValue:@"🔥" forKey:@"Crèmebrûlée"];
    [itemsEmoji setValue:@"❄️" forKey:@"Crèmefraîche"];
    [itemsEmoji setValue:@"🍝" forKey:@"Spaghetti"];
    [itemsEmoji setValue:@"🍝" forKey:@"Pâte"];
    [itemsEmoji setValue:@"🍝" forKey:@"Penne"];
    [itemsEmoji setValue:@"🍝" forKey:@"Coquillette"];
    [itemsEmoji setValue:@"🍝" forKey:@"Torsade"];
    ...
    [itemsEmoji setValue:@"🍃" forKey:@"Coriandre"];
    [itemsEmoji setValue:@"🍃" forKey:@"Marjolaine"];
    [itemsEmoji setValue:@"🍃" forKey:@"Origan"];
    [itemsEmoji setValue:@"🍃" forKey:@"Sauge"];
    [itemsEmoji setValue:@"🍃" forKey:@"Basilic"];
    [itemsEmoji setValue:@"🍹" forKey:@"Cocktail"];
    [itemsEmoji setValue:@"🍹" forKey:@"Liqueur"];
    [itemsEmoji setValue:@"🍷" forKey:@"Vinrouge"];
    [itemsEmoji setValue:@"🍷" forKey:@"Vinrosé"];
    [itemsEmoji setValue:@"🍸" forKey:@"Vinblanc"];
    [itemsEmoji setValue:@"🍸" forKey:@"Mousseux"];
    ...
    [itemsEmoji setValue:@"💦" forKey:@"Liquidevaisselle"];
    [itemsEmoji setValue:@"💦" forKey:@"Geldedouche"];
    [itemsEmoji setValue:@"💦" forKey:@"Mousseàraser"];
    [itemsEmoji setValue:@"💦" forKey:@"SavondeMarseille"];
    [itemsEmoji setValue:@"💦" forKey:@"Lave-vitre"];
    [itemsEmoji setValue:@"💦" forKey:@"Assouplissant"];
    [itemsEmoji setValue:@"💦" forKey:@"Eaudejavel"];
    [itemsEmoji setValue:@"🍬" forKey:@"Friandise"];
    [itemsEmoji setValue:@"🍬" forKey:@"Bonbon"];
    [itemsEmoji setValue:@"🍭" forKey:@"Sucette"];
