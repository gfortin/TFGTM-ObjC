...
@interface ShopListsItemsService()
...
@implementation ShopListsItemsService


+ (ShopListsItemsService *)defaultService
{
    // Create a singleton instance of ShopListsItemsService
    static ShopListsItemsService* service;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        service = [[ShopListsItemsService alloc] init];
    });
    
    return service;
}

-(ShopListsItemsService *)init
{
    self = [super init];
    ...
    if (self)
    {
        ...
        self.syncTable = [_client syncTableWithName:@"ShopListsItems"];
...
-(void)pullData:(QSCompletionBlock)completion
{
    ...
    [self.syncTable pullWithQuery:query queryId:@"allShopListsItems" completion:^(NSError *error) {
        [self logErrorIfNotNil:error];
